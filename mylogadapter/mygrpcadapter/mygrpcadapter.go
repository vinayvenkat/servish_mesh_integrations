...
//go:generate $GOPATH/src/istio.io/istio/bin/mixer_codegen.sh -a mixer/adapter/mylogadapter/mygrpcadapter/config/config.proto -x "-s=false -n mygrpcadapter -t logentry"
...
import (
	...
	"istio.io/istio/mixer/adapter/mylogadapter/mygrpcadapter/config"
