...
//go:generate $GOPATH/src/istio.io/istio/bin/mixer_codegen.sh -a mixer/adapter/mygrpcadapter/config/config.proto -x "-s=false -n mygrpcadapter -t metric -t logentry"
...
import (
    ...
    "github.com/vinayvenkat/myootadapter/mygrpcadapter/config"
